...
#' @return A comprehensive list detailing the outcomes of the mixed-effects model analysis. This includes posterior distribution samples for estimated parameters: model mean, residual variance, treatment means, contrasts between treatment levels, covariates and variance components of random effects.
#'
#'
#' @import MCMCglmm
#' @import coda
...
#'
#' @export
Bunny_v2 <- function(params, Chain=FALSE) {
  ...
  for (n in seq_along(params$hTrait)) {
    ...
    # 8.2. If there are any treatments specified, compute contrasts
